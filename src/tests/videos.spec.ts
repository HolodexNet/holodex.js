...
describe('Videos', () => {
  ...
  describe('#getVideo()', () => {
    it('should work', () => expect(client.getVideo('jdio7hLzy3w')).resolves.toMatchObject({
      videoId: 'jdio7hLzy3w',
    }));
  });

  describe('#getVideosByChannelId()', () => {
    it('query videos', () => expect(client.getVideosByChannelId('UC-hM6YJuNYVAmUWxeIr9FeA')).resolves.toContainEqual(
    ...
    it('query clips', () => expect(client.getVideosByChannelId('UC-hM6YJuNYVAmUWxeIr9FeA', VideoSearchType.Clips)).resolves.toContainEqual(
      expect.objectContaining({
        channel: expect.objectContaining({
  ...
  describe('#getVideos()', () => {
    it('should work', () => expect(client.getVideos()).resolves.toHaveLength(25));
